...
public class SecretFolderKeyStoreSpi extends KeyStoreSpi {
    ...
    public void engineStore(KeyStore.LoadStoreParameter param)
        ...
        final SecretFolderKeyStoreParameter kParam = (SecretFolderKeyStoreParameter)param;
        ...
        if (matchingFiles.length == 0) {
            ...
            keyFolder = new File(kParam.getBaseFolder(), kParam.getFolderNamePrefix() + KeyProvider.getRandomAlphanumericString(kParam.getRandomNameLength()));
